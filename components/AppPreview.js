  ...
  return (
    <div className="flex flex-col bg-white rounded-lg shadow">
      ...
      <Link href={`/apps/${app.filePath.replace(/\.mdx?$/, "")}`}>
        <a className="group relative py-6 px-2 bg-blue-500 text-white rounded-t-lg flex flex-col items-center justify-center text-2xl font-extrabold hover:bg-blue-400">
          ...
          {app.data.technologies && (
            <div className="absolute -top-5 right-3 flex space-x-2">
              {app.data.technologies.map((technology, index) => (
                <div key={index} className="bg-blue-700 p-2 rounded-lg shadow">
